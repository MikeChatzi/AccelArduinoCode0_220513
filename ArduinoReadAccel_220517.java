...
void loop()
{
  ...
  int a = constrain(int((accelG[0]+1) * 255 / 2), 0, 255);
  int b = constrain(int((accelG[1]+1) * 255 / 2), 0, 255);
  int c = constrain(int((accelG[2]+1) * 255 / 2), 0, 255);
...
//  Serial.println();
  ...
  //// Code for Comminication with Other Software
  Serial.write(a);
  delay(1);
  Serial.write(b);
  delay(1);
  ...
  delay(5);  // Delay here for visibility
}
